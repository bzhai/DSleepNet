...
def eval_precision(gt, pred, average='macro'):
    if type(gt) is pd.core.frame.DataFrame or type(gt) is pd.core.frame.Series:
        return metrics.precision_score(gt.fillna(0.0), pred.fillna(0.0), average=average, zero_division=0)*100.0
    else:
        return metrics.precision_score(gt, pred, average=average, zero_division=0)*100.0
...
def eval_recall(gt, pred, average='macro'):
    if type(gt) is pd.core.frame.DataFrame or type(gt) is pd.core.frame.Series:
        return metrics.recall_score(gt.fillna(0.0), pred.fillna(0.0), average=average, zero_division=0)* 100.0
    else:
        return metrics.recall_score(gt, pred, average=average, zero_division=0) * 100.0
...
def eval_f1(gt, pred, average='macro'):
    if type(gt) is pd.core.frame.DataFrame or type(gt) is pd.core.frame.Series:
        return metrics.f1_score(gt.fillna(0.0), pred.fillna(0.0), average=average, zero_division=0) * 100.0
    else:
        return metrics.f1_score(gt, pred, average='macro', zero_division=0) * 100.0
